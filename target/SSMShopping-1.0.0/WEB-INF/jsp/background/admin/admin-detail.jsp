		...
		<form class="layui-form">
			<div class="layui-tab" style="margin: 0;">
				<ul class="layui-tab-title">
					<li><a href="background/admin/admin">用户列表</a></li>
					<li class="layui-this">用户操作</li>
				</ul>
					...
					<div class="layui-tab-item layui-show">
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="id" value="${admin.id}" required
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<c:choose>
									<c:when test="${admin.staffStatus=='1' }">
										<input type="checkbox" name="staffStatus" value="1" title="正常"
											checked>
										<input type="checkbox" name="staffStatus" value="0" title="冻结">
									</c:when>
									<c:otherwise>
										<input type="checkbox" name="staffStatus" value="0" title="冻结"
											checked>
