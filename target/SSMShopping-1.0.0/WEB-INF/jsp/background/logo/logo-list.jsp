			...
			<form class="layui-form" action="background/logo" method="post">
				<div class="layui-form-item">
					...
					<div class="layui-inline">
						<input type="text" name="id" placeholder="请输入图片名"
							value="${logo.id}" autocomplete="off" class="layui-input">
					</div>
					<div class="layui-inline">
					...
					<button class="layui-btn layui-btn-normal excelNow" data-url="background/logo/excel">导出本页</button>
					<button class="layui-btn layui-btn-normal excelAll" data-url="background/logo/excel">导出全部</button>
				</div>
			</form>
					...
					<tbody>
						...
						<c:forEach items="${list}" var="l">
							<tr>
								...
								<td>${l.address}</td>
								<td><img alt="${l.id}" src="${l.address}" style="max-height: 100px;"></td>
								<td><button
								...
								<td>
									<div class="layui-inline">
										<button
											...
											data-id="${l.id}" data-url="background/logo/logo-detail">
											<i class="layui-icon">&#xe642;</i>
										</button>
										<button
											class="layui-btn layui-btn-small layui-btn-danger del-btn"
											data-id="${l.id}" data-url="background/logo/logo-delete">
											<i class="layui-icon">&#xe640;</i>
										</button>
									</div>
								</td>
