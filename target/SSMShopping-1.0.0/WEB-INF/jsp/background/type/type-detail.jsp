		...
		<form class="layui-form">
			<div class="layui-tab" style="margin: 0;">
				<ul class="layui-tab-title">
					<li><a href="/background/type/list">类型列表</a></li>
					<li class="layui-this">类型</li>
				</ul>
					...
					<div class="layui-tab-item layui-show">
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="id" value="${type.id}" required
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<c:choose>
									<c:when test="${type.hidden=='1' }">
										<input type="checkbox" name="hidden" value="1" title="显示"
											checked>
										<input type="checkbox" name="hidden" value="0" title="隐藏">
									</c:when>
									<c:otherwise>
										<input type="checkbox" name="hidden" value="1" title="显示">
										<input type="checkbox" name="hidden" value="0" title="隐藏"
