...
<title>商城网上商城</title>
<link rel="stylesheet" type="text/css" href="static/order/css/style.css">
<link rel="stylesheet" type="text/css" href="static/order/css/css.css" />
<script type="text/javascript" src="static/order/js/jquery-1.7.2.min.js"></script>
<script type="text/javascript">
	$(function() {
		...
		$('.Caddress .add_mi').click(
				function() {
					$(this).css('background',
							'url("static/order/images/mail_1.jpg") no-repeat').siblings(
							'.add_mi').css('background',
							'url("static/order/images/mail.jpg") no-repeat')
				})
	})
	var x = Array();
...
<body>
	...
	<div id="serach">
		<div class="logo">
			<a href=""> <img src="static/order/images/logo.png" alt="" /></a>
		...
		<div class="gouwuche">
			<div class="chetu"></div>
			<a href="forward/cart/index">去购物车结算</a>
		...
		<div class="shopping_table">
			<table border="1" bordercolor="#cccccc" cellspacing="0"
				...
				<tr>
					...
					<td><span class="span_momey">11.00</span></td>
					<td>
						<button class="btn_reduce"
							onclick="javascript:onclick_reduce(this);">-</button> <input
						class="momey_input" type="" name="" id="" value="1"
	...
	<div id="down">
		...
		<div class="down_bot">
			<img src="static/order/images/bot1.gif" alt="" /> <img src="static/order/images/bot2.gif"
				alt="" /> <img src="static/order/images/bot3.png" alt="" /> <img
