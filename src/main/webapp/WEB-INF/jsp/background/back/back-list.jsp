				...
				<div class="layui-form-item">
					<div class="layui-inline tool-btn">
						<button class="layui-btn layui-btn-small layui-btn-normal addBtn"
							data-url="background/back/back-add">
							<i class="layui-icon">&#xe654;</i>
						</button>
						<button class="layui-btn layui-btn-small layui-btn-danger delBtn"
							data-url="background/back/back-delete-many">
							<i class="layui-icon">&#xe640;</i>
						</button>
						<button
					...
					<div class="layui-inline">
						<input type="text" name="id" placeholder="请输入编号"
							value="${back.backId}" autocomplete="off" class="layui-input">
					</div>
					...
					<button class="layui-btn layui-btn-normal excelNow" data-url="background/back/excel">导出本页</button>
					<button class="layui-btn layui-btn-normal excelAll" data-url="background/back/excel">导出全部</button>
				</div>
			</form>
								...
								<td>
									<div class="layui-inline">
										<button
											...
											data-id="${l.id}" data-url="background/back/back-detail">
											<i class="layui-icon">&#xe642;</i>
										</button>
										<button
											class="layui-btn layui-btn-small layui-btn-danger del-btn"
											data-id="${l.id}" data-url="background/back/back-delete">
											<i class="layui-icon">&#xe640;</i>
										</button>
									</div>
								</td>
