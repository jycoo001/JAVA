		...
		<div class="column-content-detail">
			<form class="layui-form" action="background/goods" method="post">
				<div class="layui-form-item">
					...
					<div class="layui-inline">
						<input type="text" name="name" placeholder="请输入价格"
					...
					<button class="layui-btn layui-btn-normal excelNow" data-url="background/goods/excel">导出本页</button>
					<button class="layui-btn layui-btn-normal excelAll" data-url="background/goods/excel">导出全部</button>
				</div>
			</form>
