			...
			<form class="layui-form" action="background/admin/user" method="post">
				<div class="layui-form-item">
					...
					<div class="layui-inline">
						<input type="text" name="userId" placeholder="请输入用户名" value="${user.userId}"
				...
				<div class="page-wrap">
					...
					<ul class="pagination">
						<c:if test="${page.pageNum!=1}">
							<li><a
								href="background/admin/user?pageNumber=${pageNumber-1}&pageSize=${page.pageSize}">«</a></li>
						</c:if>
						<c:if test="${page.pageNum==1 }">
						...
						<c:forEach begin="${page.navigateFirstPage}"
							...
							<c:choose>
								...
								<c:otherwise>
									<li><a
										href="background/admin/user?pageNumber=${p}&pageSize=${page.pageSize}">${p}</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
