		...
		<form class="layui-form">
			<div class="layui-tab" style="margin: 0;">
				<ul class="layui-tab-title">
					<li><a href="background/shuffling">轮播图列表</a></li>
					<li class="layui-this">轮播图操作</li>
				</ul>
				<div class="layui-tab-content">
					<div class="layui-tab-item"></div>
					<div class="layui-tab-item layui-show">
						<div class="layui-form-item">
							<label class="layui-form-label">轮播图编号：</label>
							<div class="layui-input-block">
								<input type="text" name="id" value="${shuffling.id}" required
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="name" value="${shuffling.name}" required
									lay-verify="required" autocomplete="off" class="layui-input"
									readonly="readonly">
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<c:choose>
									<c:when test="${shuffling.status=='1'}">
										<input type="checkbox" name="status" value="1" title="正常"
											checked>
										<input type="checkbox" name="status" value="0" title="隐藏">
									</c:when>
									<c:otherwise>
										<input type="checkbox" name="status" value="0" title="隐藏"
											checked>
