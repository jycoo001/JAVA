...
<body class="iframe-h gray-bg">
	<div class="wrap-container column-wrap clearfix">
		<div class="column-edge">
			<ul class="layui-nav layui-nav-tree layui-nav-no-bg"
				lay-filter="column">
				<li class="layui-nav-item"><a href="javascript:;">单页管理</a>
				...
				<li class="layui-nav-item"><a href="javascript:;">新闻中心</a>
					<dl class="layui-nav-child">
						<dd>
				...
				<li class="layui-nav-item layui-this"><a
					href="column-news.html">产品</a></li>
				<li class="layui-nav-item"><a href="column-news.html">大数据</a></li>
			</ul>
				...
				<div class="layui-form" id="table-list">
					<table class="layui-table" lay-even lay-skin="nob">
						...
						<tbody>
							<tr>
								...
								<td class="hidden-xs">1989-10-14</td>
								<td><button
										class="layui-btn layui-btn-mini layui-btn-normal">正常</button></td>
								<td>
									<div class="layui-inline">
										<button
											class="layui-btn layui-btn-small layui-btn-normal  edit-btn"
											data-id="1">
											<i class="layui-icon">&#xe642;</i>
										</button>
										<button
					...
					<div class="page-wrap">
						<ul class="pagination">
							...
							<li><a href="/admin/category/index.html?page=2">2</a></li>
							<li><a href="/admin/category/index.html?page=2">»</a></li>
						</ul>
					</div>
				</div>
			</div>
